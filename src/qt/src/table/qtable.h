...
class QM_EXPORT_TABLE QTable : public QScrollView
{
  ...
  // ### AbanQ
  Q_PROPERTY(int defaultRowHeight READ defaultRowHeight WRITE setDefaultRowHeight)
  Q_PROPERTY(int defaultColumnWidth READ defaultColumnWidth WRITE setDefaultColumnWidth)
  // ### AbanQ
...
public:
  ...
  // ### AbanQ
  void setDefaultRowHeight(int v) {
    defaultRowHeight_ = v;
  }
  int defaultRowHeight() const {
    return defaultRowHeight_;
  }
  void setDefaultColumnWidth(int v) {
    defaultColumnWidth_ = v;
  }
