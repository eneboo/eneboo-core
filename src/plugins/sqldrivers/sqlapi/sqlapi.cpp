...
bool SqlApiDriver::beginTransaction()
{
  ...
  msgBoxCritical(tr("Transacci�n"), tr("beginTransaction no est� permitido"));
  exit(1);
  return false;
...
bool SqlApiDriver::commitTransaction()
{
  ...
  msgBoxCritical(tr("Transacci�n"), tr("commitTransaction no est� permitido"));
  exit(1);
  return false;
...
bool SqlApiDriver::rollbackTransaction()
{
  ...
  msgBoxCritical(tr("Transacci�n"), tr("rollbackTransaction no est� permitido"));
  exit(1);
  return false;
