/****************************************************************************
** $Id: qsasyntaxhighlighter.cpp  1.1.5   edited 2006-02-23T15:39:57$
**
...
{
  if (s == QT_TR_NOOP(QString::fromLatin1("Standard")))
    return QSASyntaxHighlighter::Standard;
  if (s == QT_TR_NOOP(QString::fromLatin1("Comment")))
    return QSASyntaxHighlighter::Comment;
  if (s == QT_TR_NOOP(QString::fromLatin1("Number")))
    return QSASyntaxHighlighter::Number;
  if (s == QT_TR_NOOP(QString::fromLatin1("String")))
    return QSASyntaxHighlighter::String;
  if (s == QT_TR_NOOP(QString::fromLatin1("Type")))
    return QSASyntaxHighlighter::Type;
  if (s == QT_TR_NOOP(QString::fromLatin1("Label")))
    return QSASyntaxHighlighter::Label;
  if (s == QT_TR_NOOP(QString::fromLatin1("Keyword")))
    return QSASyntaxHighlighter::Keyword;
  if (s == QT_TR_NOOP(QString::fromLatin1("Preprocessor")))
    return QSASyntaxHighlighter::PreProcessor;
  return QSASyntaxHighlighter::Standard;
}
