...
#include "idewindow.h"
#include "../editor/qsadebuggerinterface.h"
  ...
  : QObject(parent), d(new QSWorkbenchPrivate())
{
  ...
  d->dbgIface = new QSADebuggerInterface(d->ideWindow);
  d->ideWindow->setDebugger(d->dbgIface);
}
