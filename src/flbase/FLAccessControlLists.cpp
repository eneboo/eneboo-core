...
void FLAccessControlLists::process(QObject *obj)
{
  ...
  acls_list_->insert(new QString(type + QString::fromLatin1("::") + name + QString::fromLatin1("::") + user));
  if (type == "mainwindow") {
  	acls_list_->insert(new QString(type + QString::fromLatin1("::container::") + user));
  }
